...
export default function BitcoinSupply(params) {
...
const alertNoBalance = () => toast("No balance!", {
  ...
  return (
    <Box>
      <Modal
        open={params.supplyModal}
        onClose={params.supplyClose}
          ...
          >
            <Box className="modal-top">
              <img
                ...
                alt="bitcoin icon"
              />
              <h2 className="modal-title">Bitcoin Token</h2>
            </Box>
            <Box className="close-icon-box">
              <img
                className="hover"
                onClick={params.supplyClose}
                src={Close}
                alt="close button"
              />
            </Box>
          ...
          <Box sx={{ display: "flex", flexDirection: "row" }}>
            ...
            <Box className="input-modal-box-right">
              <Box className="icplogo-modal">
                <img className="icp-logo-image" src={Bitcoin} alt="Bitcoin" />
              </Box>
